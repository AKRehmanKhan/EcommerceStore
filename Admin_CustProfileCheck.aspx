<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Admin_CustProfileCheck.aspx.cs" Inherits="DB_Prpject.Admin_CustProfileCheck" %>
        ...
        <div class="row p-3 mt-4 ">
            ...
            <div class="col-md-8">
                <div class="row mt-2 d-flex justify-content-end">
                    <div class="col-md-5">
                        <asp:TextBox ID="Admin_Cust_Profile_user_text" placeholder="User Id"  CssClass="form-control" runat="server"></asp:TextBox>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="row px-4">
             ...
             <div class="col-md-8">
                <div class="p-3 ">
                    <div class="row mt-2">
                        <div class="col-md-6">
                            <label class="labels text-black-50">Full Name</label>
                            <asp:TextBox ID="Customer_full_name" class="form-control" runat="server" ReadOnly="True"></asp:TextBox>

                        </div>
                        <div class="col-md-6">
                            <label class="labels text-black-50">Phone Number</label>
                            <asp:TextBox ID="Customer_Phone_Nuber_name" class="form-control" ReadOnly="True" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6">

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminSellerProfileCheck.aspx.cs" Inherits="DB_Prpject.AdminSellerProfileCheck" %>
        ...
        <div class="row p-3 mt-4 ">
            ...
            <div class="col-md-8">
                <div class="row mt-2 d-flex justify-content-end">
                    <div class="col-md-5">
                        <asp:TextBox ID="Admin_seller_Profile_user_text" placeholder="User Id" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="p-3 ">
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <asp:TextBox ID="A_Seller_full_name" class="form-control" runat="server" ReadOnly="True"></asp:TextBox>

                        </div>
                        <div class="col-md-6">
                            <label class="labels text-black-50">Phone Number</label>
                            <asp:TextBox ID="A_Seller_phone_name" class="form-control" runat="server" ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6">

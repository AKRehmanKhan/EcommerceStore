<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="ssdinventory.aspx.cs" Inherits="DB_Prpject.ssdinventory" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           ...
                           <img id="imgview" src="laptopimajes/ssd.jpg" class="auto-style3" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="SSD ID"></asp:TextBox>
                  ...
                  <div class="row mx-auto">
                     <div class="col-4 mx-auto">
                        <asp:Button ID="Button1" class="btn btn-lg btn-block btn-success" runat="server" Text="Add" OnClick="Button1_Click" Width="96px" />
                     </div>
                     <div class="col-4 mx-auto">
                        <asp:Button ID="Button3" class="btn btn-lg btn-block btn-warning" runat="server" Text="Update" OnClick="Button3_Click" Width="95px" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete" OnClick="Button2_Click" Width="96px" />
                     </div>
                  </div>

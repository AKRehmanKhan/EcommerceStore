<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="adminMainPage.aspx.cs" Inherits="DB_Prpject.adminMainPage" %>
                 ...
                 <div id="cardvalue_sales" class="card adminSmallCards " runat="server">
                     <div class="cardbody ">
                         <div class="row">
                             <div class="col mt-3">
                                 <center>
                                    <%-- <img style="width:20px;" src="fontawesome/svgs/solid/baby-carriage.svg" />--%>
                                      <img style="width:20px;" src="Images/seller.jpg" />
                 ...
                 <div id="cardvalue_customer" class="card adminSmallCards " runat="server">
                     <div class="cardbody ">
                         <div class="row">
                             <div class="col mt-3">
                                 <center>
                                     <img style="width:20px;"  src="Images/buyer.png" />
                 ...
                 <div id="cardvalue_item" class="card adminSmallCards " runat="server">
                     <div class="cardbody ">
                         <div class="row">
                             <div class="col mt-3">
                                 <center>
                                     <img style="width:20px;"  src="Images/b1.jpg" />
                 ...
                 <div id="cardvalue_feedback" class="card adminSmallCards " runat="server">
                     <div class="cardbody ">
                         <div class="row">
                             <div class="col mt-3">
                                 <center>
                                     <img style="width:20px;" src="Images/termscond.jpg" />
                 ...
                 <div id="cardvalue_total" class="card adminSmallCards " runat="server">
                     <div class="cardbody ">
                         <div class="row">
                             <div class="col mt-3">
                                 <center>
                                     <img style="width:40px;"   src="Images/back.jpg" />
